...
function generateArray(table) {
    console.log(table);
    const out = [];
    const rows = table === null || table === void 0 ? void 0 : table.querySelectorAll('tr');
    const ranges = [];
...
export function exportJsonToExcel(params) {
    var _a, _b, _c, _d, _e;
    /* original data */
    const filename = (_a = params === null || params === void 0 ? void 0 : params.filename) !== null && _a !== void 0 ? _a : 'defaultExcel';
    const bookType = (_b = params === null || params === void 0 ? void 0 : params.bookType) !== null && _b !== void 0 ? _b : 'xlsx';
    const multiHeader = (_c = params === null || params === void 0 ? void 0 : params.multiHeader) !== null && _c !== void 0 ? _c : [];
    const merges = (_d = params === null || params === void 0 ? void 0 : params.merges) !== null && _d !== void 0 ? _d : [];
    const autoWidth = (_e = params.autoWidth) !== null && _e !== void 0 ? _e : true;
